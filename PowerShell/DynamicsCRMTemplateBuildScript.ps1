...
if ($EnableSolutionExport)
{
    ...
    Write-Host "Executing User Id" $executingUser.Id
...
if ($EnableSolutionPack)
{
    ...
    {
        & "$LocalSolutionPackagerFile" /action:Pack /zipfile:"$targetFile" /folder:"$LocalSolutionPackagerFilesFolder" /packagetype:$SolutionPackPackageType /map:"$LocalSolutionPackagerMappingFile"
    }
    else
    {
        & "$LocalSolutionPackagerFile" /action:Pack /zipfile:"$targetFile" /folder:"$LocalSolutionPackagerFilesFolder" /packagetype:$SolutionPackPackageType
    }
